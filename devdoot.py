...
st.markdown("""
    ...
    .stTabs [data-baseweb="tab"] { height: 50px; border-radius: 50px; background-color: rgba(0,0,0,0.8); color: #aaa; border: 1px solid #333; padding: 0 25px; }
    ...
    .stMetric, .stDataFrame, .stExpander { background: rgba(0,0,0,0.6); border: 1px solid rgba(0, 198, 255, 0.3); border-radius: 10px; }
    </style>
    """, unsafe_allow_html=True)
...
# --- TABS CREATION (THIS WAS MISSING!) ---
